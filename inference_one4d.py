...
def main(args):
    ...
    # Lazy-load tokenizer after denoising to avoid competing VRAM with One4D pipeline.
    tokenizer = None
    ...
    for i in range(len(prompt_list)):
        ...
        # Load decoder after denoising; inference pipeline has been released in generate_video_one4d.
